...
Proyecto Destacado: SpringEduManager 


 Descripción: Evaluación del M6: Desarrollo de aplicaciones JEE con Spring framework.
 Tecnologías: Java, Spring Tools (Eclipse), MVC, Spring Security, MySQL. 
 Funcionalidades: Manejo de Roles (Admin/User), CRUD de cursos y gestión de notas de estudiantes.
 

Sobre mí: Aprendí Java, SQL y manejo de herramientas como VS Code, MySQL Workbench y Eclipse. Apasionado por la tecnología, el voleibol y el aprendizaje continuo. 

Objetivo: Desarrollar soluciones tecnológicas que impacten en el deporte en Chile.

 #java #frontend #vscode #eclipse #springsecurity #sql

CASO DE ESTUDIO.

 Sección del Portafolio: Proyectos Destacados - Backend Java 
...
Por último, elegí estas dos empresas por algo en particular. Siempre he sido del mundo del streaming, lo realizo día a día, por ende, enforcarme y aprender más sobre este mundo, me motiva y me da seguridad para seguir aprendiendo.
